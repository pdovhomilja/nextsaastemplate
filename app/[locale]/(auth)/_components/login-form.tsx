...
const LoginForm = () => {
  ...
  const urlError =
    searchParams.get("error") === "OAuthAccountNotLinked"
      ? "Tento email je již používán pro přihlášení pomocí jiného providera. Prosím použijte takový, který jse použili poprvé."
      : "";
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    {...field}
                    disabled={isPending}
                    placeholder="pavel.novak@faircredit.cz"
                    type="email"
                  />
                </FormControl>
                <FormMessage />
